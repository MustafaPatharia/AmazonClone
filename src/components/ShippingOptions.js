  ...
  return (
    <div className="flex flex-col py-8">
        ...
        <div className="grid grid-cols-4 mt-4">
            <div className="col-span-2 lg:col-span-3 flex-col flex space-y-3 text-sm md:text-base pr-3">                
                ...
                <div className="form-check flex">
                    ...
                    <label className="form-check-label inline-block text-gray-500 whitespace-pre-wrap" for="paid_shipping">
                    Delivery in <span className="font-semibold whitespace-pre-wrap">next 2 days (AED 15)</span>
                </label>
                </div>
            </div>
            <div className="flex flex-col space-y-2 md:mr-5 col-span-2 lg:col-span-1 text-xs md:text-base">
